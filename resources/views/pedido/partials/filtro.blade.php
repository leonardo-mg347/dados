<form>
    <a href="/pedidos"><button type="submit" class="btn btn-dark">Todos</button></a>
    <button type="submit" name="filtro" value="Em Análise" class="btn btn-warning">Em Análise</button>
    <button type="submit" name="filtro" value="Em Produção" class="btn btn-secondary">Em Produção</button>
